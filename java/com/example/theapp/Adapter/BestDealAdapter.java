package com.example.theapp.Adapter;
...
import com.example.theapp.Activity.DetailActivity;
import com.example.theapp.Domain.ItemDomain;
import com.example.theapp.databinding.ViewholderBestDealBinding;
...
public class BestDealAdapter extends RecyclerView.Adapter<BestDealAdapter.Viewholder> {
    ...
    public BestDealAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewholderBestDealBinding binding = ViewholderBestDealBinding.inflate(LayoutInflater.from(parent.getContext()));
